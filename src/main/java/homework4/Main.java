...
public class Main {
    ...
    private static final int SizeMap = 5;
    private static final int CharToWin = 4;
    ...
    private static void humanMove() {
        ...
        do {
            ...
            sc.nextLine();
        } while(!checkInp(XCoord, YCoord));
        MyMap[XCoord][YCoord] = XChar;
    }
    ...
    private static boolean checkInp(int x, int y){
    ...
    private static void computerMove() {
        ...
        do {
            ...
            x_coordinate = random.nextInt(SizeMap);
            y_coordinate = random.nextInt(SizeMap);
        } while (!(checkInp(x_coordinate, y_coordinate)));
